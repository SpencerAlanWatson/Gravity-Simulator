define([], function () {
    ...
    Rectangle.prototype.containsRect = function (otherRect) {
        if (this.width <= 0 || this.height <= 0)
            return false;
        ...
        if (otherRect.contains(x1, y1) || otherRect.contains(x2, y1) || otherRect.contains(x1, y2) || otherRect.contains(x2, y2)) {
